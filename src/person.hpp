...
/**
 * @brief A class for persons in the city. Each person has a name, type, working place and home.
 * In addition they will have a car and a schedule, once they are added into the city.
 * Starting location for person and its car is at home.
 */
...
public:
     ...
     * @param personType The type of person (Neutral, Angry, Lazy, Gentleman, Active and Nocturnal)
